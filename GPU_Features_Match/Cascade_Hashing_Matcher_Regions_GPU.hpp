...
#ifndef OPENMVG_MATCHING_CASCADE_HASHING_MATCHER_REGIONS_GPU_HPP
#define OPENMVG_MATCHING_CASCADE_HASHING_MATCHER_REGIONS_GPU_HPP
...
namespace openMVG {
	namespace matching_image_collection {
		...
		///
		class Cascade_Hashing_Matcher_Regions_GPU : public Matcher
		{
		public:
			explicit Cascade_Hashing_Matcher_Regions_GPU
			(
				float dist_ratio
			);
...
#endif // OPENMVG_MATCHING_CASCADE_HASHING_MATCHER_REGIONS_GPU_HPP
